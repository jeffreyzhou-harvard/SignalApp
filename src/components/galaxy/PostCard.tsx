  ...
  return (
    <div>
      ...
      <article className="rounded-xl border border-line bg-surface px-3.5 py-3">
        <header className="flex items-center gap-2.5">
          ...
          <div className="min-w-0">
            <p className="flex items-center gap-1 truncate text-[13px] font-semibold">
              {displayName}
              <svg viewBox="0 0 22 22" width="14" height="14" fill="var(--color-accent)" aria-label="Verified">
        ...
        <p className="mt-2.5 whitespace-pre-wrap text-[13px] leading-5">{variant.copy}</p>
        ...
        <footer className="mt-2.5 flex items-center justify-between pr-6 text-faint">
